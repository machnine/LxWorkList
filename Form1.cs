...
namespace LxWorkList
{
    public partial class Form1 : Form
    {
        ...
        string RSDBF = Properties.Settings.Default.RenalSytemDBF;
        string OutputPath = "";
        ...
        private DataTable readTableFromSolidOrgan(string querystring)
        {
            OleDbDataAdapter dataAdaptor = new OleDbDataAdapter(querystring, SolidOrganDB);
        ...
        private void getUntestedList()//get a list of untested runs
        {
            ...
            dTable = readTableFromSolidOrgan(query);
        ...
        private void getCurrentWorklist(int worklistnumber)   //get currently selected worklist
        {
            ...
            dtAbSera = readTableFromSolidOrgan(query);   //fill datatable with all samples in a worklist
            ...
            dtScrPref = readTableFromSolidOrgan(query); //fill datatable with all AO information
